  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Dad, night-shift worker, and self-taught builder. I turn everyday friction into focused products — DistrictForge for school facilities, Dadmark for fatherhood."
        />
      ...
      <ScrollView style={styles.page} contentContainerStyle={styles.pageContent}>
        <View style={styles.navWrap}>
          <View style={styles.nav}>
            ...
            <View style={styles.navLinks}>
              <Pressable accessibilityRole="link" onPress={() => scrollToId("work")} style={({ pressed }) => [styles.navTextButton, pressed && styles.pressed]}>
                <Text style={styles.navButtonText}>WORK</Text>
              </Pressable>
              <Pressable accessibilityRole="link" onPress={() => scrollToId("about")} style={({ pressed }) => [styles.navTextButton, pressed && styles.pressed]}>
                <Text style={styles.navButtonText}>ABOUT</Text>
              </Pressable>
              <Pressable
                accessibilityRole="link"
                accessibilityLabel="Jump to contact"
        ...
        <View style={[styles.hero, compact && styles.heroCompact]}>
          <View style={[styles.heroCopy, compact && styles.heroCopyCompact]}>
            ...
            <Text style={[styles.heroTitle, compact && styles.heroTitleCompact, narrow && styles.heroTitleNarrow]}>
              I build operational software from problems I live with.
            </Text>
            <Text style={[styles.heroBody, compact && styles.heroBodyCompact]}>
              School facilities by day. Fatherhood at night. I’m Jared—a dad, night-shift worker, and self-taught builder turning everyday friction into focused products.
            </Text>
            <View style={[styles.heroActions, narrow && styles.heroActionsNarrow]}>
              <Pressable
                accessibilityRole="link"
                onPress={() => scrollToId("work")}
            ...
            <View style={[styles.projectBody, compact && styles.projectBodyCompact]}>
              <View style={styles.projectCopy}>
                ...
                <Text style={styles.projectDescription}>
                  One operational system for work orders, assets, inspections, inventory, purchasing, budgets, facility use, and long-range planning — built from the floor of a real district, not a feature list.
                </Text>
                <View style={styles.projectPoints}>
                  <Text style={styles.projectPoint}>Problem: facilities work is scattered across paper, email, and disconnected tools.</Text>
                  <Text style={styles.projectPoint}>Approach: one record for the building, the request, and the budget behind it.</Text>
                  <Text style={styles.projectPoint}>Status: active prototype. Feedback from people who run the buildings shapes what ships next.</Text>
                </View>
              </View>
          ...
          >
            ...
            <View style={[styles.projectBody, compact && styles.projectBodyCompact]}>
              <View style={styles.projectCopy}>
                ...
                <View style={styles.projectPoints}>
                  <Text style={[styles.projectPoint, styles.projectPointDark]}>Problem: most “dad content” is jokes or generic advice that ignores the kid in front of you.</Text>
                  <Text style={[styles.projectPoint, styles.projectPointDark]}>Approach: small, specific moments shaped by real fatherhood and user feedback.</Text>
                  <Text style={[styles.projectPoint, styles.projectPointDark]}>Status: private beta. Built in the hours after a night shift.</Text>
                </View>
              </View>
        ...
        <View nativeID="about" style={styles.aboutSection}>
          <View style={[styles.sectionHeadingRow, compact && styles.sectionHeadingRowCompact]}>
            <View>
              ...
              <Text style={[styles.sectionTitle, compact && styles.sectionTitleCompact]}>The person behind the products.</Text>
            </View>
          </View>
          <View style={[styles.aboutGrid, compact && styles.aboutGridCompact]}>
            <Text style={styles.aboutLead}>
              I don’t start with a category. I start with a job I already have — keeping buildings running, or being a dad with limited hours — and I build the tool I wish existed.
            </Text>
            <View style={styles.aboutFacts}>
              <Text style={styles.aboutFactLabel}>HOW I SHIP</Text>
              <Text style={styles.aboutFact}>Solo, self-taught, nights and weekends around a night-shift job.</Text>
              <Text style={styles.aboutFactLabel}>WHAT I WON’T BUILD</Text>
              <Text style={styles.aboutFact}>Generic SaaS with no user in the room. Marketing pages for products I wouldn’t use.</Text>
              <Text style={styles.aboutFactLabel}>BEST REASON TO WRITE</Text>
              <Text style={styles.aboutFact}>You run school facilities, you’re a dad testing Dadmark, or you have a sharp problem and want a builder who will live with it.</Text>
            </View>
          </View>
        </View>
        ...
        <View nativeID="contact" style={styles.contactSection}>
          ...
          <Text style={styles.contactBody}>
            Best for school-ops questions, Dadmark feedback, or a problem you keep running into. I reply to jaredrachlin@gmail.com — usually within a few days.
          </Text>
        ...
        <View style={[styles.footer, compact && styles.footerCompact]}>
          ...
          <Pressable accessibilityRole="link" onPress={() => Linking.openURL("mailto:jaredrachlin@gmail.com")}>
            <Text style={styles.footerLink}>jaredrachlin@gmail.com</Text>
          </Pressable>
          <Pressable accessibilityRole="link" onPress={() => Linking.openURL("https://dadmark.app")}>
            <Text style={styles.footerLink}>Dadmark</Text>
          </Pressable>
...
const styles = StyleSheet.create({
  ...
  navTextButton: { height: 42, paddingHorizontal: 12, alignItems: "center", justifyContent: "center" },
  ...
  projectPoints: { marginTop: 18, gap: 8, maxWidth: 690 },
  projectPoint: { color: "#D5E4F4", fontSize: 14, lineHeight: 22 },
  projectPointDark: { color: "#5C5349" },
  aboutSection: { width: "100%", maxWidth: 1240, alignSelf: "center", paddingHorizontal: 28, paddingTop: 24, paddingBottom: 72 },
  aboutGrid: { flexDirection: "row", gap: 48, alignItems: "flex-start" },
  aboutGridCompact: { flexDirection: "column", gap: 28 },
  aboutLead: { flex: 1.1, color: colors.navy, fontSize: 22, lineHeight: 34, fontWeight: "600", letterSpacing: -0.3 },
  aboutFacts: { flex: 0.9, gap: 8 },
  aboutFactLabel: { color: colors.blue, fontSize: 11, fontWeight: "900", letterSpacing: 1.8, marginTop: 14 },
  aboutFact: { color: colors.slate, fontSize: 15, lineHeight: 24 },
  ...
  footerLink: { color: colors.navy, fontSize: 12, fontWeight: "700" },
